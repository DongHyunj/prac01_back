...
public class LikesService {
    ...
    //      Isolation : 격리성, 동시에 실행 중인 트랜잭션은 서로 영향을 주지 않는다
    ...
    //  스프링의 Transactional와 DB의 Transactional은 비슷하지만 적용되는 레벨이 다르다.
    //      스프링의 Transactional와 어플리케이션
    //      DB의 Transactional와은 DB에서만 적용
